...
//         {/* Gradient orbs */}
//         <div className="absolute top-32 -left-24 md:-left-48 w-48 h-48 md:w-96 md:h-96 bg-orange-500/15 rounded-full blur-xl animate-pulse" />
//         <div className="absolute bottom-32 -right-24 md:-right-48 w-48 h-48 md:w-96 md:h-96 bg-yellow-500/15 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1.5s' }} />
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 md:w-[500px] md:h-[500px] bg-red-500/10 rounded-full blur-xl animate-pulse" style={{ animationDelay: '3s' }} />
//       </div>
...
//             {/* Glow effect */}
//             <div className="absolute inset-0 blur-xl bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 opacity-30 animate-pulse" />
